...
def process_song_file(cur, filepath):
    """Process and import data into song and artist tables"""
...
def process_log_file(cur, filepath):
    """Process and import data into user and song tables"""
    # open log file
    df = pd.read_json(filepath,lines=True)
...
def process_data(cur, conn, filepath, func):
    """Get the file data and process the files""" 
...
def main():
    """Connect to database and process song and log data"""
